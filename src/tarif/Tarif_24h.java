...
public class Tarif_24h extends JFrame {
    ...
    private void cellsValues() {
        ...
        for (int i=0; i < moId.size(); i++) {
            ...
            List<Integer> list1 = mediatorDB.getListV_24h(moId.get(i));
            List<Integer> list2 = mediatorDB.getListTarif_24h(moId.get(i));
